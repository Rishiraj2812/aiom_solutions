    ...
    <div>
      ...
      <div className="container mx-auto  md:pl-20 md:pr-20">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full md:w-1/2 lg:w-1/4 p-4 transform transition-transform duration-500 ease-in-out hover:scale-105">
              <div className="bg-transparent mx-auto rounded-lg shadow-md text-center overflow-hidden h-50 w-64">
              <img src="https://img.freepik.com/free-photo/businesspeople-working-finance-accounting-analyze-financi_74952-1399.jpg?w=996&t=st=1703182490~exp=1703183090~hmac=da9d04b4d97f1230681ee67f332ccb56fdd6acecb62937a59efea3f583b00e13" alt="Service Image" className="w-full h-auto"/>
          ...
          <div className="w-full md:w-1/2 lg:w-1/4 p-4 transform transition-transform duration-500 ease-in-out hover:scale-105">
              <div className="bg-transparent mx-auto rounded-lg shadow-md text-center overflow-hidden h-50 w-64">
              <img src="https://img.freepik.com/free-photo/guy-left-side-talking-colleagues-is-listening-him-group-young-freelancers-office-have-conversation-smiling_146671-13632.jpg?w=996&t=st=1703182573~exp=1703183173~hmac=5bca522441ee51634be5b77d56eb9504f8c80e4d98d3ca9de02b8bcd56a69de5" alt="Service Image" className="w-full h-auto"/>
